...
episode_rexps = [ # ... Season 2 ...
                  ...
                  # ... s02e13 ...
                  (r'[Ss](?P<season>[0-9]{1,2}).{,3}[Ee](?P<episodeNumber>[0-9]{1,2})[^0-9]', 1.0, (0, -1)),
                  (r'[Ss](?P<season>[0-9]{1,2}).{,3}[Xx](?P<extraNumber>[0-9]{1,2})[^0-9]', 1.0, (0, -1)),
...
bonus_rexps = [ # extra
                (r'[^0-9][Xx](?P<extraNumber>([0-9]{1,2}))', 0.8, (0, 0)),
                (r'[^0-9](?:bonus|extra|special feature)(?P<extraNumber>([0-9]{1,2}))', 0.8, (0, 0)),
                ]
